// list the ERV reference sequences
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'fasta-refseqs-erv'"]);
...
_.each(seqIds, function(seqId) {
    ...
    glue.inMode("sequence/fasta-refseqs-erv/"+seqId, function() {
